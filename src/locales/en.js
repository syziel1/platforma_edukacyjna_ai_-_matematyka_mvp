export const en = {
  ...
  'describeRelationshipRadiusVolume': 'Describe the relationship between radius and volume',
  'describeRelationshipHeightVolume': 'Describe the relationship between height and volume',
  'provideOptimalProportions': 'What is the optimal relationship between height and radius?',
  'hintLargerRadius': 'Hint: Larger radius = larger base, but less material for height',
  'hintLargerHeight': 'Hint: Larger height = larger volume, but smaller base radius',
  'hintSquareCrossSection': 'Hint: Think about a "square" vertical cross-section of the tank',
  'solutionSummary': 'Solution Summary',
  'optimalRelation': 'Optimal relation',
  'exampleDimensions': 'Example: if r = 3m, then h = 6m',
  'volumeCalculation': 'Volume of such tank',
  'surfaceAreaCalculation': 'Material surface area',
  'engineeringConclusion': 'Engineering Conclusion',
  'engineeringConclusionText': 'A tank with proportions h = 2r uses material most efficiently, maximizing volume with minimal material usage. This is why many real tanks have similar proportions!',
