  ...
  return (
    <div className="bg-bg-card rounded-xl p-6 shadow-lg border border-bg-neutral">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-accent-primary to-accent-secondary text-white py-3 px-4 rounded-lg hover:from-accent-primary/90 hover:to-accent-secondary/90 transition-all duration-200 font-medium text-lg flex items-center justify-center gap-2 transform hover:scale-105 active:scale-95"
      >
        {t('continuelearning')}
